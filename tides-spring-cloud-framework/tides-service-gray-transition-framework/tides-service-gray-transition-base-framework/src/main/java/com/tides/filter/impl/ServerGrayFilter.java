...
import static com.tides.constant.Constant.GRAY_FLAG_FALSE;
import static com.tides.constant.Constant.GRAY_FLAG_TRUE;
        ...
        try {
            ...
            if (!result && grayFromRequest.equalsIgnoreCase(GRAY_FLAG_TRUE)) {
                if (CollectionUtil.isEmpty(servers)) {
                    throw new TidesFrameException(BaseCode.SERVER_LIST_NOT_EXIST);
                }
