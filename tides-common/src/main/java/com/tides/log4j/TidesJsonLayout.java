...
/**
 * @description: 潮声项目自定义 JSON 日志布局
 * @author: 19continue
 **/
@Plugin(name = "TidesJsonLayout", category = Node.CATEGORY, elementType = Layout.ELEMENT_TYPE, printObject = true)
public final class TidesJsonLayout extends BaseJsonLayout {

    private static final String JSON_ARRAY_START = "[";
    private static final String JSON_ARRAY_END = "]";
    private static final String MIME_TYPE = "application/json";

    private TidesJsonLayout(Configuration config, boolean locationInfo, boolean properties,
     ...
     */
    @PluginFactory
    public static TidesJsonLayout newLayout(
        ...
        return new TidesJsonLayout(config, locationInfo, properties, threadContextAsList,
     ...
     * 创建默认实例（用于测试）
     */
    public static TidesJsonLayout defaultLayout() {
        return new TidesJsonLayout(new DefaultConfiguration(), false, false, false,
