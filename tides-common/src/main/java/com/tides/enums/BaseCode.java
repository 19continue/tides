...
public enum BaseCode {
    ...
    PRICE_ERROR(40008,"入参的订单价格与座位规定价格不一致"),
    ...
    MOVIE_SCREENING_NOT_EXIST(50012,"电影场次不存在"),

    MOVIE_SCREENING_NOT_SELLING(50013,"电影场次不可售"),

    TICKET_CODE_NOT_EXIST(50014,"ticket code does not exist"),

    TICKET_STATUS_NOT_PERMIT(50015,"ticket status does not permit this operation"),

    TICKET_USED_CAN_NOT_REFUND(50016,"used ticket can not refund"),

    ORDER_REFUND_TIME_EXPIRED(50017,"refund time expired"),

    ORDER_REFUND_ERROR(50018,"order refund error"),
    ...
    DEMO_DATA_SNAPSHOT_NOT_EXIST(70104, "演示数据快照不存在，请先保存当前状态"),
    ;
