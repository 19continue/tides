package com.tides.lockinfo;


import com.tides.core.SpringUtil;
import com.tides.parser.ExtParameterNameDiscoverer;
...
import static com.tides.core.Constants.SEPARATOR;
...
public abstract class AbstractLockInfoHandle implements LockInfoHandle {
    ...
    public String getLockName(JoinPoint joinPoint,String name,String[] keys){
        ...
        return prefix + "-{" + prefix + "}-" + getLockPrefixName() + SEPARATOR + name + getRelKey(joinPoint, keys);
    }
    @Override
