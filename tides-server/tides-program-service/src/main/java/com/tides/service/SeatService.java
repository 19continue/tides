...
import com.tides.dto.SeatAddDto;
import com.tides.dto.SeatBatchAddDto;
import com.tides.dto.SeatBatchRelateInfoAddDto;
import com.tides.dto.SeatListDto;
...
import com.tides.vo.SeatRelateInfoVo;
...
public class SeatService extends ServiceImpl<SeatMapper, Seat> {
    ...
    public Long add(SeatAddDto seatAddDto) {
        ...
        if (Objects.nonNull(seat)) {
            throw new TidesFrameException(BaseCode.SEAT_IS_EXIST);
        }
        seat = new Seat();
