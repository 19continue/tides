...
import com.tides.dto.DepthRuleDto;
import com.tides.dto.DepthRuleStatusDto;
import com.tides.dto.DepthRuleUpdateDto;
import com.tides.entity.DepthRule;
import com.tides.enums.BaseCode;
import com.tides.enums.RuleStatus;
import com.tides.exception.TidesFrameException;
import com.tides.mapper.DepthRuleMapper;
    ...
    public void check(String startTimeWindow, String endTimeWindow){
        ...
        for (final DepthRule depthRule : depthRules) {
            ...
            if (checkStartLimitTimeResult || checkEndLimitTimeResult) {
                throw new TidesFrameException(BaseCode.API_RULE_TIME_WINDOW_INTERSECT);
            }
        }
    }
