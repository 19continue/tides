...
import com.tides.conf.RequestTemporaryWrapper;
...
import com.tides.pro.limit.RateLimiter;
import com.tides.pro.limit.RateLimiterProperty;
import com.tides.property.GatewayProperty;
import com.tides.service.ApiRestrictService;
import com.tides.service.ChannelDataService;
import com.tides.service.TokenService;
import com.tides.threadlocal.BaseParameterHolder;
import com.tides.util.RsaSignTool;
import com.tides.util.RsaTool;
...
import static com.tides.constant.Constant.GRAY_PARAMETER;
import static com.tides.constant.Constant.TRACE_ID;
import static com.tides.constant.GatewayConstant.BUSINESS_BODY;
import static com.tides.constant.GatewayConstant.CODE;
import static com.tides.constant.GatewayConstant.ENCRYPT;
import static com.tides.constant.GatewayConstant.NO_VERIFY;
import static com.tides.constant.GatewayConstant.REQUEST_BODY;
import static com.tides.constant.GatewayConstant.TOKEN;
import static com.tides.constant.GatewayConstant.USER_ID;
import static com.tides.constant.GatewayConstant.V2;
import static com.tides.constant.GatewayConstant.VERIFY_VALUE;
...
public class RequestValidationFilter implements GlobalFilter, Ordered {
    ...
    private Map<String,String> doExecute(String originalBody,ServerWebExchange exchange){
        ...
        if ((!allowNormalAccess) && (VERIFY_VALUE.equals(noVerify))) {
            throw new TidesFrameException(BaseCode.ONLY_SIGNATURE_ACCESS_IS_ALLOWED);
        }
        if (checkParameter(originalBody,noVerify) && !skipCheckParameter(url)) {
            ...
            if (!checkFlag) {
                throw new TidesFrameException(BaseCode.RSA_SIGN_ERROR);
            }
