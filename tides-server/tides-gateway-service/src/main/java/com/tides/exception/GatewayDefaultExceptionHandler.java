...
public class GatewayDefaultExceptionHandler implements ErrorWebExceptionHandler {
    ...
    public Mono<Void> handle(ServerWebExchange exchange, Throwable ex) {
        ...
        }else if (ex instanceof TidesFrameException) {
            TidesFrameException tidesFrameException = (TidesFrameException)ex;
            ApiResponse<String> apiResponse = ApiResponse.error(tidesFrameException.getCode(), tidesFrameException.getMessage());
