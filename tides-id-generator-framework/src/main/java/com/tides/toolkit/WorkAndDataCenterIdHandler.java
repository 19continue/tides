...
public class WorkAndDataCenterIdHandler {
    ...
    private final String SNOWFLAKE_WORK_ID_KEY = "{tides}:snowflake_work_id";
    
    private final String SNOWFLAKE_DATA_CENTER_ID_key = "{tides}:snowflake_data_center_id";
