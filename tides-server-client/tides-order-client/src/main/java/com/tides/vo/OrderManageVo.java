...
public class OrderManageVo {
    ...
    @Schema(name ="cancelOrderTime", type ="Date", description ="订单取消时间")
    private Date cancelOrderTime;

    @Schema(name ="ticketCount", type ="Integer", description ="购票人票数")
    private Integer ticketCount;

    @Schema(name ="issuedTicketCount", type ="Integer", description ="已出票票数")
    private Integer issuedTicketCount;

    @Schema(name ="usedTicketCount", type ="Integer", description ="已核销票数")
    private Integer usedTicketCount;

    @Schema(name ="refundingTicketCount", type ="Integer", description ="退款中票数")
    private Integer refundingTicketCount;
