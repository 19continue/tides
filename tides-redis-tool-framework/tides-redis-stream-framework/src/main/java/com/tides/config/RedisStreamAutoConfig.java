...
import com.tides.MessageConsumer;
import com.tides.RedisStreamConfigProperties;
import com.tides.RedisStreamHandler;
import com.tides.RedisStreamListener;
import com.tides.RedisStreamPushHandler;
import com.tides.constant.RedisStreamConstant;
...
public class RedisStreamAutoConfig {
    ...
    public void checkConsumerType(String consumerType){
        if ((!RedisStreamConstant.GROUP.equals(consumerType)) && (!RedisStreamConstant.BROADCAST.equals(consumerType))) {
            throw new TidesFrameException(BaseCode.REDIS_STREAM_CONSUMER_TYPE_NOT_EXIST);
        }
    }
}
